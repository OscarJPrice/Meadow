...
ShaderModule::ShaderModule(const char *filename,
  ...
  ATTEMPT_VK(vkCreateShaderModule(device->vk_logical_device,
...
ShaderModule::shader_stage_info(const char *name) const {
