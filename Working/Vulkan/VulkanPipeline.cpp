...
VulkanPipeline::VulkanPipeline(
    ...
    std::vector<VkPipelineShaderStageCreateInfo> shader_stages, bool blend)
    : swapchain(swapchain), shader_stages(std::move(shader_stages)),
      blend(blend) {
  create();
}
...
void VulkanPipeline::destroy() {
  ...
  vkDestroyPipelineLayout(swapchain.device.vk_logical_device, pipeline_layout,
                          nullptr);
}
